...
export function AboutUs() {
  return (
    <S.AboutUs>
      <Container>
        <h3 className="font-18-semibold">O Centro Pokémon </h3>

        <br />

        <h4 className="font-16-medium"> Como funciona a cura de um pokémon? </h4>
        ...
        <h4 className="font-16-medium">Uma tradição de mais de 20 anos</h4>
        ...
        <h4 className="font-16-medium">O melhor para seu pokémon</h4>
        ...
        <h4 className="font-16-medium">Alta Tecnologia</h4>
